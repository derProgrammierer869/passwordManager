...
#change the way the program addesses the user by the key of the dictionary from the sign up step. 
#fix the failed login
#add a setting to change login 
#maybe make a settings menu for menu 3 or others
#make sure all opened files get closed